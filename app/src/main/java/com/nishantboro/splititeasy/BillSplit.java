...
import com.nishantboro.splititeasy.R;

public class BillSplit extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set toolbar
        Toolbar toolbar = findViewById(R.id.activity_split_toolbar);
        ...
        View createNewGroup = findViewById(R.id.createNewGroups);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()) {
            ...
            case R.id.createNewGroups: intent = new Intent(this,CreateNewGroupActivity.class);startActivity(intent);break;
            default:break;
        }
    }
